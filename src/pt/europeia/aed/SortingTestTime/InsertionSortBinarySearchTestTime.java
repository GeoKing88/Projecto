...
import pt.europeia.aed.book.chapter2.section1.InsertionWithMovesAndBinarySearch;
...
public class InsertionSortBinarySearchTestTime {
    ...
    public static int contiguousRepetitionsFor(Double[][] doubles) {
        ...
        do {
            ...
            InsertionWithMovesAndBinarySearch.sort(doubles[contiguousRepetitions]);
    ...
    public static double executionTimeFor(final Double[][] doubleArray) {
        ...
        for (int i = 0; i != doubleArray.length; i++) {
            InsertionWithMovesAndBinarySearch.sort(doubleArray[i]);
        }
